...
interface AlertCreationAttributes extends Optional<AlertAttributes, 'id' | 'created_at' | 'resolved' | 'resolved_at'> {}
...
export class Alert extends Model<AlertAttributes, AlertCreationAttributes> implements AlertAttributes {
    ...
    public static associate(models: any) {
        ...
        Alert.belongsTo(models.Product, { foreignKey: 'product_id', as: 'product' });
    }
